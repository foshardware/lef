...
ibm01_lef = decodeUtf8 $(embedFile "ibm-place2/ibm01/ibm01.lef")
ibm02_lef = decodeUtf8 $(embedFile "ibm-place2/ibm02/ibm02-5l.lef")
ibm07_lef = decodeUtf8 $(embedFile "ibm-place2/ibm07/ibm07-5l.lef")
ibm08_lef = decodeUtf8 $(embedFile "ibm-place2/ibm08/ibm08-5l.lef")
ibm09_lef = decodeUtf8 $(embedFile "ibm-place2/ibm09/ibm09-5l.lef")
ibm10_lef = decodeUtf8 $(embedFile "ibm-place2/ibm10/ibm10-5l.lef")
ibm11_lef = decodeUtf8 $(embedFile "ibm-place2/ibm11/ibm11-5l.lef")
ibm12_lef = decodeUtf8 $(embedFile "ibm-place2/ibm12/ibm12-5l.lef")
